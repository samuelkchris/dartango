...
void main() {
  group('DatabaseConfig', () {
    ...
    test('should support copyWith', () {
      ...
      expect(
          newConfig.backend, equals(DatabaseBackend.postgresql)); // unchanged
    });
  });
  ...
  group('SQLiteConnection', () {
    ...
    test('should execute SELECT queries', () async {
      ...
      await connection
          .execute('INSERT INTO users (name, age) VALUES (?, ?)', ['Bob', 30]);
    ...
    test('should support transactions', () async {
      ...
      // Verify changes
      final result =
          await connection.execute('SELECT balance FROM accounts ORDER BY id');
    ...
    test('should rollback transaction on error', () async {
      ...
      await connection
          .execute('INSERT INTO test_table (value) VALUES (?)', [1]);
      ...
      final result =
          await connection.execute('SELECT COUNT(*) as count FROM test_table');
    ...
    test('should handle savepoints', () async {
      ...
      await connection
          .execute('INSERT INTO test_savepoints (value) VALUES (?)', ['A']);

      await connection.setSavepoint('sp1');
      await connection
          .execute('INSERT INTO test_savepoints (value) VALUES (?)', ['B']);
