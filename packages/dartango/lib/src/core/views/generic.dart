...
abstract class MultipleObjectMixin extends GenericView {
  ...
  Future<List<Model>> getObjectList(
      HttpRequest request, Map<String, dynamic> kwargs) async {
...
class DetailView extends SingleObjectMixin {
  ...
  Template getTemplate(HttpRequest request) {
    ...
    if (name == null) {
      throw ViewException(
          'DetailView requires either a templateName or an implementation of getTemplateName()');
    }
...
class ListView extends MultipleObjectMixin {
  ...
  Template getTemplate(HttpRequest request) {
    ...
    if (name == null) {
      throw ViewException(
          'ListView requires either a templateName or an implementation of getTemplateName()');
    }
...
abstract class FormMixin extends GenericView {
  ...
  Future<HttpResponse> formValid(
      HttpRequest request, Map<String, dynamic> form) async {
  ...
  Future<HttpResponse> formInvalid(HttpRequest request,
      Map<String, dynamic> form, Map<String, dynamic> errors) async {
  ...
  Template getTemplate(HttpRequest request) {
    ...
    if (name == null) {
      throw ViewException(
          'FormMixin requires either a templateName or an implementation of getTemplateName()');
    }
...
class FormView extends FormMixin {
  ...
  Future<Map<String, dynamic>> validateForm(
      HttpRequest request, Map<String, dynamic> form) async {
  ...
  Template getTemplate(HttpRequest request) {
    ...
    if (name == null) {
      throw ViewException(
          'FormView requires either a templateName or an implementation of getTemplateName()');
    }
...
class UpdateView extends FormMixin {
  ...
  Future<Model> updateObject(
      HttpRequest request, Model object, Map<String, dynamic> form) async {
...
class DeleteView extends SingleObjectMixin {
  ...
  Template getTemplate(HttpRequest request) {
    ...
    if (name == null) {
      throw ViewException(
          'DeleteView requires either a templateName or an implementation of getTemplateName()');
    }
